...
class Notebook {
  ...
  //save getAll ishlatish va json ichidagi notebooklani frontga chiqarish
  async save() {
    const notebooks = await Notebook.getAll();
  ...
  static async getById(id) {
    const notebooks = await Notebook.getAll(); //bu yerda getall bazadaki barcha data ni chiqarib beradi.
